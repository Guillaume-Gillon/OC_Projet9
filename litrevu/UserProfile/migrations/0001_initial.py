    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ImageField(blank=True, null=True, upload_to='static/images/uploaded')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_modified', models.DateTimeField(blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UserProfile.ticket')),
            ],
        ),
    ]
